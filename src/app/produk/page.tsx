        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 pb-6 border-b border-slate-100">
          <div className="max-w-3xl space-y-4">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-50 border border-emerald-200/60 text-emerald-700 text-xs font-mono font-medium">
              ...
              <span>Standar K3 & Pipa 1.8mm SNI</span>
            </div>
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-slate-950 tracking-tight leading-tight">
              Katalog Scaffolding & Shoring
            </h1>
            <p className="text-sm sm:text-base text-slate-600 leading-relaxed">
              Perancah baja bersertifikasi resmi, presisi tinggi, dan lapisan anti-karat untuk keamanan konstruksi.
            </p>
          </div>
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-md bg-slate-950 hover:bg-orange-600 text-white text-xs font-semibold uppercase tracking-wider transition-all shadow-sm active:scale-[0.98]"
            >
